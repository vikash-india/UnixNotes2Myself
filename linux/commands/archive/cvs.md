# Description: The cvs Command

### Notes
* The cvs command is for Concurrent Versions System.
* Important: If you have a choice then choose git over cvs ANYDAY.
* CVS client needs to be installed before using this tool.
* Add .cvsignore in every directory containing pattern for each of the files to be ignored. These files will not show
