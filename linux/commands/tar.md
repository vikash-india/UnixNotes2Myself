# Description: The tar Command

### Notes
* The tar command is the GNU version of the tar archiving utility to convert a group of files into an archive.
...
* The tar command does not perform compression by default.
