...
------------------------------------------------------------------------------------------------------------------------
\               Used in an escape sequence to match a special symbol. Eg. \t matches a tab and \* matches * literally.
...
print expression, expression, ... >> filename               Append to the end of filename rather than just to the screen.
